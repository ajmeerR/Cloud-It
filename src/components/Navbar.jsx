        ...
        <div className='fixed z-10 w-screen h-16 text-black bg-indigo-50 drop-shadow-lg'>
            <div className='flex items-center justify-between w-full h-full max-w-6xl px-2 mx-auto'>
                <div className='flex items-center'>
                    <h1 className='mr-4 text-3xl font-bold text-gray-800 sm:text-4xl lg:mr-20 '>Tarcin Robotic.</h1>
                ...
                <div className='hidden md:flex'>          
                    <button className='px-4 py-2 mx-2'><Link to="footer" smooth={true} offset={10} duration={500}>Contact Us</Link></button>
                </div>
            ...
            <ul className={!nav ? 'hidden' : 'absolute w-full px-8 text-gray-800 bg-indigo-100'}>
                ...
                <div className='flex flex-col'>
                    <button className='px-4 py-2 m-2 '><Link onClick={() => {setNav(!nav)}} to="footer" smooth={true} offset={10} duration={500}>Contact Us</Link></button>
                </div>
            </ul>
        </div>
    )
